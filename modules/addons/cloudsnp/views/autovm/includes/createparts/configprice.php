...
<div class="row" style="--bs-bg-opacity: 0.1;">
    ...
    <div v-if="planAddressPrice != null">
        <div class="input-group mb-1">
            <span class="input-group-text col-4 m-0 p-0"style="background-color: #ffffff00; border: 0;"  id="planAddressPrice">
    ...
    <div v-if="planTrafficPrice != null">
        <div class="input-group mb-1">
            <span class="input-group-text col-4 m-0 p-0"style="background-color: #ffffff00; border: 0;"  id="planTrafficPrice">
